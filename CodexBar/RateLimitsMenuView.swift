...
struct RateLimitsMenuView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: Metrics.verticalSpacing) {
            ...
            errorView(notificationSettings.errorMessage)
            controls
        }
...
private extension RateLimitsMenuView {
    ...
    var notificationToggle: some View {
        settingsToggle(
            ...
            setEnabled: { notificationSettings.setEnabled($0) }
        )
    }
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            HStack(alignment: .firstTextBaseline) {
                ...
                hoveredMetric
                Spacer()
                metric(label: "累计 Token", value: usage.summary.lifetimeTokens, alignment: .trailing)
            }
