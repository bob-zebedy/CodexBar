...
- macOS 15.0 或更高版本
- 已安装 [Codex CLI](https://github.com/openai/codex) (全局 `codex` 命令) 或 Codex.app
...
CodexBar 只与本机 Codex app-server 进程通信。账号信息和额度数据不会被收集和发送到任何个人和服务
只有更新 App 会产生额外的网络请求仅包含 [appcast](https://codexbar.zabrian.app/appcast.xml) 和 appcast 中对应的 DMG 下载地址
