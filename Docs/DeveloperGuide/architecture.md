...
| `CodexBarTests` | 无 App 宿主的 Swift Testing 单元测试，直接编译生产源码并隔离测试数据 |

App 与 helper 通过 [`CodexBarHelperXPC.swift`](../../Shared/CodexBarHelperXPC.swift) 共享 XPC 协议。
